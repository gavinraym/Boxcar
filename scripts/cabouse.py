...
#==============================================================================
    ...
    def _award_points(self, points, dice_list):
        log('run award_points(), points = {points}, dice = {dice}')
        self.points += points
        for die in dice_list:
            die.freeze()
        log(f'end award_points(), points={self.points}')
...
#==============================================================================
    ...
    def roll(self):
        ...
        log(f'run roll: dice = {[_.pips() for _ in self.dice]}')
        log(f'run points(), score={self.points}')

#=======FULL RUN is scored with dice pips of [1][2][3][4][5][6]
        if [_.pips() for _ in self.dice] == [1,2,3,4,5,6]:
            log('Full Run indicated')
